...
function mpesa() {
  ...
  return (
    <div className="flex relative px-3 pt-32 items-center z-0 flex-col">
      ...
      <ul className="text-xl">
        <li>
          1. <span className="font-semibold">1234</span> for the business
          number.
        </li>
        <li>
          2. <span className="font-semibold">1234567</span> for the
          account number.
        </li>
        <li>
      ...
      <Link href="/">
        <button className="bg-blue-500 my-4 rounded-lg  px-3 py-2 text-slate-50">
          I have made Payment
        </button>
      </Link>
    </div>
